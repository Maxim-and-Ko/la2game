...
const bgTree = document.getElementById("parallax-cloud");
const bgGirl = document.getElementById("parallax-girl");
...
function MoveBackground(e)
{
   ...
   bgGirl.setAttribute("style", "background-position: " + offsetX + "px " + offsetY + "px;");
}
